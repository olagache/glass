...
<html>
	...
	<body>
        ...
        <div class="table">
            <form:form action="/jobs/${fn:escapeXml(group)}/${fn:escapeXml(name)}/triggers/new-cron" commandName="form" method="POST" >
                <table>
                    <tr>
                        <td>job group :</td>
                    ...
                    <tr>
                        ...
                        <td><form:input path="cronExpression" /><form:errors path="cronExpression" />&nbsp;<a href="#cron-documentation">documentation</a></td>
                    </tr>
                    <tr>
                        <td>job data map :</td>
