...
<html>
	...
	<body>
        ...
        <div class="table">
            <form:form action="/jobs/${fn:escapeXml(group)}/${fn:escapeXml(name)}/triggers/${fn:escapeXml(triggerGroup)}/${fn:escapeXml(triggerName)}/edit-simple" commandName="form" method="POST" >
                <table>
                    <tr>
                        <td>job group :</td>
