...
DROP TABLE IF EXISTS glass_FIRED_TRIGGERS;
DROP TABLE IF EXISTS glass_PAUSED_TRIGGER_GRPS;
DROP TABLE IF EXISTS glass_SCHEDULER_STATE;
DROP TABLE IF EXISTS glass_LOCKS;
DROP TABLE IF EXISTS glass_SIMPLE_TRIGGERS;
DROP TABLE IF EXISTS glass_SIMPROP_TRIGGERS;
DROP TABLE IF EXISTS glass_CRON_TRIGGERS;
DROP TABLE IF EXISTS glass_BLOB_TRIGGERS;
DROP TABLE IF EXISTS glass_TRIGGERS;
DROP TABLE IF EXISTS glass_JOB_DETAILS;
DROP TABLE IF EXISTS glass_CALENDARS;
